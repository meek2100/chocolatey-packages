...
$url_part1 = 'https://product-downloads.atlassian.com/software/sourcetree/windows/ga/SourceTreeSetup-'
$url_part2 = '.exe'
...
function global:au_GetLatest {
    $homepage_content = Invoke-WebRequest -UseBasicParsing -Uri $download_page_url
     ...
     # Get Version
    $homepage_content -match 'https://product-downloads.atlassian.com/software/sourcetree/windows/ga/SourceTreeSetup-\d+\.\d+\.\d+'| Out-Null
	$version = $matches[0] -replace "https://product-downloads.atlassian.com/software/sourcetree/windows/ga/SourceTreeSetup-", ""
